---
title: "Ciberseguridad para la administración pública en Región de Murcia: ENS, NIS2 y cumplimiento obligatorio"
image: "cover.png"
description: "Guía de ciberseguridad para ayuntamientos y organismos públicos de Región de Murcia: requisitos ENS, NIS2, plazos, herramientas del CCN y cómo cumplir la normativa de seguridad obligatoria."
slug: "ciberseguridad-administracion-publica-region-de-murcia"
date: 2026-08-22
publishDate: 2026-08-22
lastmod: 2026-08-22
draft: false
tags: ["ENS", "Administración Pública", "NIS2", "Región de Murcia"]
categories: ["Compliance"]
author: "David Moya"
keyword: "ciberseguridad administracion publica Región de Murcia"
funnel: "mofu"
geo_target: "Región de Murcia"
---

La administración pública de Región de Murcia gestiona más de 100 organismos públicos que deben cumplir el Esquema Nacional de Seguridad (ENS). Con una población de 1.5 millones de habitantes y sectores críticos como agroalimentaria, turismo, logística, la ciberseguridad no es opcional: es una obligación legal recogida en el Real Decreto 311/2022. En esta guía detallamos los requisitos, plazos y pasos concretos para que los organismos públicos de Región de Murcia cumplan con el ENS y se preparen para NIS2.
...
El Real Decreto 311/2022 establece que todas las administraciones públicas deben categorizar sus sistemas, implementar las medidas de seguridad correspondientes y someterse a auditorías periódicas. Para los organismos de Región de Murcia, esto implica adaptar sus infraestructuras tecnológicas a los requisitos del ENS según el nivel de seguridad (alto, medio o bajo) que corresponda a cada sistema.

## ¿Qué nivel ENS necesitan los ayuntamientos de Región de Murcia?

La mayoría de los ayuntamientos de Región de Murcia necesitan al menos un nivel ENS medio para sus sistemas principales (padrón, sede electrónica, gestión tributaria). Los ayuntamientos de mayor tamaño o los que gestionan datos sensibles (servicios sociales, policía local) pueden requerir nivel ENS alto.
...
## ¿Cómo afecta NIS2 a los organismos públicos de Región de Murcia?

La Directiva NIS2, que España está transponiendo a su legislación nacional, amplía las obligaciones de ciberseguridad a las administraciones públicas. Los organismos de Región de Murcia que gestionen servicios esenciales (sanidad, transporte, agua, energía) estarán directamente afectados.
...
## ¿Qué recursos tiene Región de Murcia para la ciberseguridad pública?

Región de Murcia cuenta con CSIRT.es como referencia para la gestión de incidentes de seguridad. Además, el CCN-CERT proporciona a todos los organismos públicos españoles acceso a herramientas como PILAR (análisis de riesgos), INES (estado de cumplimiento del ENS), LUCIA (gestión de ciberincidentes) y microCLAUDIA (protección de endpoints).

Estas herramientas son gratuitas para la administración pública y permiten a los organismos de Región de Murcia avanzar en el cumplimiento del ENS sin necesidad de grandes inversiones en software.

## ¿Cuáles son los principales riesgos de ciberseguridad en Región de Murcia?

Los sectores de agroalimentaria, turismo, logística que caracterizan la economía de Región de Murcia presentan riesgos específicos. Los ataques de ransomware a ayuntamientos españoles han crecido un 35% entre 2024 y 2025 según datos del CCN-CERT. Los organismos públicos de Región de Murcia son objetivo por la cantidad de datos personales que gestionan y, en muchos casos, por la falta de recursos dedicados a ciberseguridad.
...
## ¿Cómo empezar a cumplir el ENS en un ayuntamiento de Región de Murcia?
...
### ¿Es obligatorio el ENS para todos los ayuntamientos de Región de Murcia?

Sí. El ENS es obligatorio para todas las administraciones públicas españolas, independientemente de su tamaño. Esto incluye a los 45 ayuntamientos de Región de Murcia, así como a sus organismos autónomos y empresas públicas que gestionen sistemas de información.

### ¿Cuánto cuesta cumplir el ENS en un ayuntamiento?

El coste depende del tamaño del ayuntamiento y del nivel de seguridad requerido. Para un ayuntamiento mediano de Región de Murcia, el coste total (consultoría, implementación y auditoría) oscila entre 15.000 y 50.000 euros para nivel medio. Las herramientas del CCN (PILAR, INES, LUCIA) son gratuitas para la administración pública, lo que reduce significativamente el coste.
